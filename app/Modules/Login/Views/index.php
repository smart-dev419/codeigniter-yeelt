                    ...
                    <div class="nk-block nk-block-middle nk-auth-body">
                        ...
                        <div class="nk-block-head">
                            <div class="nk-block-head-content">
                                <h5 class="nk-block-title"><?= lang("Login.title") ?></h5>
                        ...
                        <form action="<?= base_url('login/process'); ?>" method="post">
                            <div class="form-group">
                                <div class="form-label-group">
                                    <label class="form-label" for="default-01"><?= lang("Login.username") ?></label>
                                    <a class="link link-primary link-sm" tabindex="-1" href="#"><?= lang("Login.username_help") ?></a>
                                </div>
                                <input type="text" name="emailaddress" class="form-control form-control-lg" id="default-01" placeholder="<?= lang("Login.username_placeholder") ?>">
                            </div><!-- .foem-group -->
                            <div class="form-group">
                                <div class="form-label-group">
                                    <label class="form-label" for="password"><?= lang("Login.passcode") ?></label>
                                    <a class="link link-primary link-sm" tabindex="-1" href="<?= base_url('login/forgotPassword_form') ?>"><?= lang("Login.passcode_help") ?></a>
                                </div>
                            ...
                            <div class="form-group">
                                <button type="submit" class="btn btn-lg btn-primary btn-block"><?= lang("Login.button") ?></button>
                            </div>
                        </form><!-- form -->
                        <div class="text-center mt-5">
                            <span class="fw-500"><?= lang("Login.noaccount") ?> <a href="<?= base_url('login/register_form'); ?>"><?= lang("Login.noaccount_link") ?></a></span>
                        </div>
                    </div><!-- .nk-block -->
