                    ...
                    <div class="nk-block nk-block-middle nk-auth-body">                        
                        <div class="nk-block-head">
                            <div class="nk-block-head-content">
                                <h3 class="nk-block-title">Password Forgotten</h3>
                                <div class="nk-block-des">
                                    <p>Please fill in your email. You will get an mail with a new password and a link to log in with the new password.</p>
                                </div>
                            </div>
                        </div><!-- .nk-block-head -->
                        ...
                        <form action="<?= base_url('login/forgot_password'); ?>" method="post">
                            <div class="form-group">                                
                                <input type="text" name="emailaddress" class="form-control form-control-lg" id="default-01" placeholder="Fill in your email">
                            </div><!-- .foem-group -->                            
                            <div class="form-group">
